...
DESCRIPTION: CREATE Table peaple_heights and INSERT into the Table the following
Columns(person_id, name, height_inches, gender) with their accompanying rows as writen bellow.
*/
